<?php include "header.php"; ?>
		...
		<div class="row">
			...
			<div class="panel panel-default">
				...
				<h2 style="text-muted"><span class="glyphicon glyphicon-list"></span> ABOUT US</h2>
						...
						<p>Politeknik Poliprofesi Medan (PPM) merupakan salah satu lembaga pendidikan yang bernaung dari yayasan pendidikan Poliprofesi Medan yang berdiri pada tahun 1992 dengan izin operasional yang di keluarkan oleh departemen tenaga kerja RI di kantor wilayah Propinsi Sumatera Utara dengan nama latihan kerja (LPK) dan Yayasan pendidikan Jakarta International Center Medan (YPJIC), dengan program pelatihan kursus tiga bulan s/d 6 bulan. <br/><br/>
						Pada tahun2002 Yayasan pendidikan Jakarta International Center Medan (YPJIC) berubah nama menjadi Yayasan Pendidikan Poliprofesi Medan (YPPM) dengan akta notaris N0.12 tanggal 14-02-2002 dengan Notaris Ngikut Meliala, SH di Medan. Politeknik Poliprofesi Medan(PPM) membuka program studi dengan 5 jurusan sebagai berikut:
						<ul>
						<li>Teknik Komputer</li>
						<li>Teknik Informatika Komputer</li>
						<li>Manajemen Informatika Komputer</li>
						<li>Bahasa Inggris</li>
						<li>Akuntasi Komputer</li>
						</ul>
				</p>
				</div>
      </div>
		...
		<div class="row">
			<div class="col-md-12">
				<center>Copyright &copy 2018 Website Politeknik Poliprofesi Medan, design with <span class="glyphicon glyphicon-heart"></span> by Roberto Kaban<br/>
				<a href="#">Home </a> | <a href="#">About Us </a> | <a href="#">Contact Us </a> | <a href="#">Login </a><br/><br/>
				<label class="label label-danger">PERHATIAN:</label>Semua informasi di halaman ini memiliki hak cipta, anda tidak diperkenankan untuk menyebarluaskan tanpa seijin pengelola website
				</center>
			</div>
			</div>
		</div><!-- Akhir FOOTER -->
